...
import 'cache_component_registrar.dart';
import 'cache.dart';
import 'cache_error_handler.dart';
import 'simple_cache_manager.dart';
import 'concurrent_map_cache_storage.dart';
import 'simple_cache_resolver.dart';
...
final class CacheConfiguration {
  ...
  ///
  /// Uses [ConcurrentMapCacheStorage], an in-memory, thread-safe cache store suitable for
  /// lightweight caching scenarios.
  @Pod(value: CACHE_STORAGE_POD_NAME)
  @ConditionalOnMissingPod(values: [ClassType<CacheStorage>()])
  CacheStorage cacheStorage() => ConcurrentMapCacheStorage();
