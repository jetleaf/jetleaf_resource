...
/// const WhenEnv(key: 'APP_MODE', value: 'production', match: WhenMatching.equals);
///
/// // Activate if DEBUG flag exists
/// const WhenEnv(key: 'DEBUG', match: WhenMatching.exists);
///
/// // Activate if environment name matches regex
/// const WhenEnv(key: 'APP_ENV', value: r'^(dev|test)$', match: WhenMatching.matches);
/// ```
/// {@endtemplate}
final class WhenEnv implements ResourceCondition {
  ...
  FutureOr<bool> shouldApply(OperationContext context) {
    ...
    switch (match) {
      case WhenMatching.EQUALS:
        return currentValue != null && currentValue == value;
      case WhenMatching.NOT_EQUALS:
        return currentValue != null && currentValue != value;
      case WhenMatching.EQUALS_IGNORE_CASE:
        return currentValue != null && value != null && currentValue.equalsIgnoreCase(value!);
      case WhenMatching.NOT_EQUALS_IGNORE_CASE:
        return currentValue != null && value != null && currentValue.notEqualsIgnoreCase(value!);
      case WhenMatching.EXISTS:
        return env.containsProperty(key);
      case WhenMatching.NOT_EXISTS:
        return !env.containsProperty(key);
      case WhenMatching.REGEX:
