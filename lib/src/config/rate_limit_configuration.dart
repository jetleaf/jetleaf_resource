...
import '../rate_limit/manager/rate_limit_manager.dart';
import '../rate_limit/resolver/rate_limit_resolver.dart';
import '../rate_limit/storage/default_rate_limit_storage.dart';
import '../rate_limit/core/rate_limit_component_registrar.dart';
import '../rate_limit/manager/simple_rate_limit_manager.dart';
import '../rate_limit/resolver/simple_rate_limit_resolver.dart';
import '../rate_limit/storage/rate_limit_storage.dart';
import '../rate_limit/storage/roll_back_capable_rate_limit_storage.dart';
...
/// 2. [rateLimitStorage]: Default in-memory, thread-safe [DefaultRateLimitStorage].
...
final class RateLimitConfiguration {
  ...
  ///
  /// Uses [DefaultRateLimitStorage], an in-memory, thread-safe rateLimit store suitable for
  ...
  RateLimitStorage rateLimitStorage() => DefaultRateLimitStorage();
